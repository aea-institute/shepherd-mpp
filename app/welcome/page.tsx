...
// the source copy for this page. "Introduction" is the eyebrow label (BODY[0],
// retained from the layout); the athlete source paragraphs begin at the next
// line. The HEADING below is unchanged. Do not reword, condense, or
// re-punctuate. The body is all paragraphs — there is no bulleted list.
...
const BODY: string[] = [
  ...
  "As a Shepherd athlete, we believe your mental game goes far deeper than performance. Scripture is filled with principles of mindset, perseverance, self-talk, courage, joy, and self-control. These are the very qualities that defined David and the very qualities that define mentally strong athletes today.",
  "You have giants in front of you. Pressure. Doubt. Fear. Opponents. Moments that feel bigger than you.",
  "David faced his giant (Goliath) and won – not because he was the most physically gifted or talented. David overcame because he had done the unseen work of learning to trust God and stay focused on Him at all times (Psalm 16:8), giving him an edge when it mattered most.",
  "Now it's your turn.",
